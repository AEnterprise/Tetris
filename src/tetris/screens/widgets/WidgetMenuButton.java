 ...
 */
public class WidgetMenuButton extends WidgetBase {
	private String text;
	...
	public WidgetMenuButton setColors(Color backgroundNormal, Color backgroundHover, Color textNormal, Color textHover) {
